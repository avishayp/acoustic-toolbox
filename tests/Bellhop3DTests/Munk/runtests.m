...
plotshd( 'slice3dHatRaycenInc.shd', 3, 1, 2 )
caxisrev( [ 50 100 ] )

bellhop3d slice3dHatRaycenSemi
plotshd( 'slice3dHatRaycenSemi.shd', 3, 1, 3 )
caxisrev( [ 50 100 ] )
...
plotshd( 'slice3dHatCartInc.shd', 3, 1, 2 )
caxisrev( [ 50 100 ] )

bellhop3d slice3dHatCartSemi
plotshd( 'slice3dHatCartSemi.shd', 3, 1, 3 )
caxisrev( [ 50 100 ] )
...
plotshd( 'slice3dGaussianInc.shd', 3, 1, 2 )
caxisrev( [ 50 100 ] )

bellhop3d slice3dGaussianSemi
plotshd( 'slice3dGaussianSemi.shd', 3, 1, 3 )
caxisrev( [ 50 100 ] )
