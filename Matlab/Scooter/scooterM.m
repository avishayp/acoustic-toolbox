...
PlotType    = 'rectilin  ';
Pos.Nrr   = NkPts;
Pos.r.range = omega ./ rk;   % store phasespeeds in slot usually used for receiver ranges
% note p is 4-d: p( Ntheta, Nsd, Nrd, Nrr )
pressure( 1, 1 : Pos.Nsd, 1 : Pos.Nrd, 1 : Pos.Nrr ) = Green;  % store Green's function in slot usually used for pressure

freqVec( 1 ) = freq;
save( grnfil, 'PlotTitle', 'PlotType', 'freqVec', 'atten', 'Pos', 'pressure' )
fieldsco( grnfil );
