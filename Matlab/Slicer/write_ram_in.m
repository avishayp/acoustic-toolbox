...
zs = Pos.s.depth( 1 );	% depth of the source 
zr = Pos.r.depth( 1 );	% depth of the TL line
...
d_range = 1000.0 * Pos.r.range( 1 );	% convert km -> m
...
rmax = 1000.0 * Pos.r.range( end );		% maximum range (m)
