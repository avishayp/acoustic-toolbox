...
CONTAINS
  ...
  COMPLEX               :: PhiR( maxM, * ), PhiIn( maxM ), PhiOut( maxM ), PhiS( maxM, * ), const( maxM ), PhiInt
...
SUBROUTINE SourceElement( iElement, Outside, RIn, ROut, xs, ys, tsx, tsy, MProp, M, maxM, &
                          k, PhiR, PhiS, const, kIn, PhiIn, kOut, PhiOut )
...
SUBROUTINE OUT( iElement, NewElement, Outside, ROut, xs, ys, tsx, tsy, MProp, M, maxM, k, PhiR, kOut, PhiOut )
  ...
  REAL,    INTENT( IN  ) :: tsx, tsy         ! tangent for the bearing line
